...
@Component({
  ...
  template: `
    <div [style.width.px]="width" [style.height.px]="height">
      <div class="advanced-pie chart" [style.width.px]="width /2" [style.height.px]="height">
      ...
      <div class="advanced-pie-legend-wrapper" [style.width.px]="width / 2" [style.height.px]="height">
...
export class AdvancedPieChartComponent extends BaseChartComponent {
  ...
  update(): void {
    ...
    this.outerRadius = 138 /2//Math.min(this.dims.width, this.dims.height) / 2.5;    
    this.innerRadius = this.outerRadius * 0.65;
    this.transform = `translate(${this.width /4} , ${this.height / 2})`;
  }
