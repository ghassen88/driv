...
@Component({
  ...
  template: `
    ...
    <svg:g *ngIf="showXaxisLine" transform="translate(0,0)">
      <svg:g  [attr.transform]="gridLineTransform()">
        <svg:line class="gridline-path gridline-path-vertical" [attr.y1]="-gridLineHeight" y2="20" />
      </svg:g>
    </svg:g>
    ...
    <svg:g *ngFor="let event of events">
      <svg:g [attr.transform]="transform(event.value)">
      <svg:circle 
        class="event-circle"
