...
export class ChartComponent implements OnChanges {
  ...
  update(): void {
    ...
    else if (this.chartWidth < 1) {
      this.chartWidth = Math.floor((this.view[0] * this.chartWidth))
    }
    else {
    ...
    this.legendWidth = (!this.legendOptions || this.legendOptions.position === 'right')
      ...
      : this.chartWidth;
    else if (this.legendWidth < 1) {
      this.legendWidth = Math.floor((this.view[0] * this.legendWidth));
    }      
  }
